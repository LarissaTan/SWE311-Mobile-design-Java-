...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    */
    ...
    public static final String CREATE_GAME = "create table if not exists tb_Game(gameId integer primary key autoincrement, gameName varchar(50), typeId integer, level int, gamePicture int, link varchar(100), goal int, foreign key(typeId) references tb_CourseType(typeId));";
    ...
    public static final String CREATE_DELIVERGOODS =  "create table if not exists tb_DeliverGoods(id int primary key, word varchar(10), corrGood int, wrongGood1 int, wrongGood2 int,audio int)";
